...
| 전원 끔 | 수십 µA | 딥슬립. ePaper 는 전원이 끊겨도 그림이 남아 꺼진 화면이 유지된다 |
...
| 설정 | 값 | 절감 |
|---|---|---|
| `WIFI_MODEM_SLEEP` | true | 30\~50 mA |
| `CPU_FREQ_MHZ` | 160 | 15\~25 mA |

모뎀 슬립은 비콘 사이에 무선을 재우므로 수신이 잠깐씩 끊긴다. 입력 버퍼가
640KB(192kbps 기준 약 27초)라 흡수되지만, 문제가 생기면 1분 상태 로그의
`버퍼 %` 가 먼저 떨어진다.
